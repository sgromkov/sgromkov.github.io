    ...
    render: function() {
        return (
            <div className="portfolio">
                <Navigation type={this.state.currentType}/>
                <Projects type={this.state.currentType}/>
            </div>
        );
    }
});
...
var Navigation = React.createClass({
    ...
    handleClick: function(typeCode) {
        if(typeCode != this.props.type) {
            // this.state.currentType = typeCode;
            ...
            <ul className="portfolio__nav">
                {
                    this.state.types.map(function(item) {
                        var classNameMod = (self.props.type == item.code) ? "portfolio__navitem_active" : "";
                        return (
                            <li
                                className={`portfolio__navitem ${classNameMod}`}
                                onClick={self.handleClick(item.code)}
                                key={item.code}
                            >
                                {item.title.ru}
                            </li>
            ...
            <div className="portfolio__list clearfix">
                {
                    this.state.projects.map(function(item) {
                        i++
                        return (
                            <div className="portfolio__item" data-type={item.type} key={i}>
                                <Work
                                    url={item.url}
                                    image={item.logo}
                                    title={item.title.ru}
...
var Work = React.createClass({
    render: function() {
        return (
            <div className="work">
                <a className="work__image-wrapper" href={`http://${this.props.url}`}>
                ...
                <div className="work__title">
                    <a className="work__site" href={`http://${this.props.url}`}>{this.props.url}</a>
                    <br/>
                    <a className="work__page" href={`http://${this.props.url}`}>
                        {this.props.title}
                    </a>
                </div>
            </div>
